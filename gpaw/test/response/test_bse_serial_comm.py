"""Test that BSE works with a serial communicator.

BSE should not attempt to construct BLACS grids when given a serial
communicator, since SerialCommunicator has no real MPI C object.
"""
import numpy as np
import pytest
...
def test_bse_diagonalize_with_serial_comm(in_tmp_dir, gpw_files):
    ...
    # This should not raise RuntimeError('No real C object')
