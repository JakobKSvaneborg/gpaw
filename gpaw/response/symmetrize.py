...
def initialize_G_maps(symmetries: QSymmetries, qpd: SingleQPWDescriptor):
    ...
    # Build the reverse lookup {Q -> G} once. Prior code scanned Q_G with
    # np.argwhere for every G and every symmetry, i.e. O(nG^2 * nsym); the
    # dict version is O(nG * nsym).
